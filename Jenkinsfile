    ...
    stages {
        ...
        stage('Docker Build image'){
            steps {
                ...
                docker tag poc-1:v1.$BUILD_ID keerthimandla/keerthi/poc-1:v1.$BUILD_ID
                docker push keerthimandla/keerthi/poc-1:v1.$BUILD_ID
                docker rmi poc-1:v1.$BUILD_ID
                docker rmi keerthimandla/keerthi/poc-1:v1.$BUILD_ID''' 
            }
        }
